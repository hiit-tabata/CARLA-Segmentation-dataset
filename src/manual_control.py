...
if not os.path.exists(RGB_FOLDER_NAME):
    os.makedirs(RGB_FOLDER_NAME)
if not os.path.exists(SEGMENTATION_FOLDER_NAME):
    os.makedirs(SEGMENTATION_FOLDER_NAME)
...
class CarlaGame(object):
    def __init__(self, carla_client, args):
        ...
        self._last_save_time = current_milli_time()
